...
class __TwigTemplate_2c11eab9bebbf93a0a76be8a14b309f0098f10d0d6f11f9bac551f3f1024346b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        ";
            // line 7
            echo (((isset($context["render_as_html"]) || array_key_exists("render_as_html", $context) ? $context["render_as_html"] : (function () { throw new RuntimeError('Variable "render_as_html" does not exist.', 7, $this->source); })())) ? (nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 7, $this->source); })()), "formattedValue", [], "any", false, false, false, 7), "html", null, true))) : (nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 7, $this->source); })()), "formattedValue", [], "any", false, false, false, 7), "html", null, true))));
            echo "
    </span>
";
        } else {
...
{% if ea.crud.currentAction == 'detail' %}
    <span title=\"{{ field.value }}\">
        {{ render_as_html ? field.formattedValue|nl2br|raw : field.formattedValue|nl2br }}
    </span>
{% else %}
    <span title=\"{{ field.value }}\">
...
{% endif %}
", "@EasyAdmin/crud/field/textarea.html.twig", "C:\\Users\\assou\\Desktop\\AssouBoutique\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\field\\textarea.html.twig");
    }
}
